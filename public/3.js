          ...
          _c(
            ...
            _vm._l(_vm.changes, function(change) {
              return _c("div", { key: change.id }, [
                ...
                _vm._v(" "),
                _c("em", [
                  _vm._v("Nome: " + _vm._s(change.before_changes.nome))
                ]),
                _c("br"),
                _vm._v(" "),
                _c("em", [
                  _vm._v("Preço: " + _vm._s(change.before_changes.preco))
                ]),
                _c("br"),
                _vm._v(" "),
                _c("em", [
                  _vm._v(
                    "Quantidade: " + _vm._s(change.before_changes.quantidade)
                  )
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [_vm._v("historico de Quantidade")]
                ),
                _vm._v(" "),
                _c("p"),
                _vm._v(" "),
                _c("p", [
                  ...
                  _vm._v(" "),
                  _c("em", [
                    _vm._v("Nome: " + _vm._s(change.after_changes.nome))
                  ]),
                  _c("br"),
                  _vm._v(" "),
                  _c("em", [
                  ...
                  _c("em", [
                    _vm._v(
                      "Quantidade: " + _vm._s(change.after_changes.quantidade)
                    )
                  ])
                ])
              ])
